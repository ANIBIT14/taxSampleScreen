/* eslint-disable max-len,react/sort-comp,class-methods-use-this,no-await-in-loop,no-restricted-syntax */
    ...
    this.setPropState(
      ...
      () => {
        if (changeDefaultValue) {
          ...
          } else if (this.state.choice.value === value) {
            this.reset();
          }
        }
      },
  ...
  getItems() {
    if (this.state.searchableText) {
      ...
      return this.props.items.filter(
        (item) => item.label && item.label.toLowerCase().indexOf(text) > -1,
      );
    }
        ...
        <TouchableOpacity
          ...
          <Text
            style={[
              ...
              this.state.choice.icon && {marginLeft: 10},
            ]}>
            {multiple
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      {
                        opacity: item?.disabled || false ? 0.3 : 1,
...
DropDownPicker.defaultProps = {
  ...
  customArrowUp: (size, color) => (
    <Entypo name="triangle-up" size={size} color={color} />
  ),
  customArrowDown: (size, color) => (
    <Entypo name="triangle-down" size={size} color={color} />
  ),
  customTickIcon: () => <Entypo name="check" size={15} />,
  zIndex: 5000,
  disabled: false,
  searchable: false,
